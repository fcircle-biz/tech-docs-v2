...
業務で発生した取引のうち、会計に影響するものが最後に集まる先である会計の入口です。売上・費用・利益の関係、掛取引で生まれる売掛金・買掛金、そして取引を記録する共通フォーマットである仕訳のしくみを、簿記の知識ゼロから理解します。
...
マスタ・トランザクション・伝票・ステータス・締め処理・バッチ処理・システム連携という、業務システム開発の設計や打ち合わせで頻繁に登場する共通用語を整理します。第2章以降で見てきた業務が、システムではどう表現されるのかがつながります。
...
販売・購買・在庫・生産・人事で発生した取引のうち、会計に影響する主要なデータが会計へ集約される全体像を1枚の図で振り返り、業務システム同士がどこでつながっているのかを確認します。新人SEが業務知識をどう使い、現場でどう学び続けるかの指針でしめくくります。
