...
- **必須**: [Claude 入門学習ガイド](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/generative-ai/claude/claude-learning-material-01.html)、[Claude Code 入門学習ガイド](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code/claude-code-learning-material-01.html) の内容（Claude Code の起動・基本的なやり取り・CLAUDE.md・サブエージェントの概要）
- **必須**: 基本的なターミナル操作（`cd`・`ls`・`mkdir` などのコマンド実行）
- **推奨**: Markdown / YAML の読み書き、Git の基本操作（`commit`・`push`）

## 学習コンテンツ

### [1. スキルとは何か](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-01.html)
...
### [2. スキルの置き場所と優先順位](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-02.html)
...
### [3. 最初のスキルを作る](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-03.html)
...
### [4. スキルのテストと発見の仕組み](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-04.html)
...
### [5. 効果的な description の書き方](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-05.html)
...
### [6. メタデータと allowed-tools](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-06.html)
...
### [7. 段階的開示と複数ファイル構成](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-07.html)
...
### [8. スクリプト・参照資料・アセットの活用](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-08.html)
...
### [9. CLAUDE.md・スラッシュコマンドとの使い分け](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-09.html)
...
### [10. サブエージェント・フック・MCPとの比較](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-10.html)
...
### [11. スキルの共有と配布](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-11.html)
...
### [12. トラブルシューティングと次のステップ](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code-skills/claude-code-skills-learning-material-12.html)
...
- [Claude Code 入門学習ガイド](https://fcircle-biz.github.io/tech-docs-v2/guide/ai/ai-coding/claude-code/claude-code-learning-material-01.html) — サブエージェント・MCP・フックなど、スキルと組み合わせる機能を復習する
